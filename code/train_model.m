...
function [A_new,B_new,P_new,log_lh] = train_model(O,A,B,P)
...
for e = 1:E
    ...
    [denom_A,numer_A,denom_B,numer_B,gamma_1,log_prob] = reestimate_model_N(obs,A,B,alpha_hat,beta_hat,scale_new);
